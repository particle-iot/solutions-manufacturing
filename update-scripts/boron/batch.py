...
def inspect():
	...
	flag2 = "System module #1 - version 1400," in text
	flag3 = "UUID: 62DC2988E4C594949F20400A5929F1D50B2959BAC1F26BFCC1A356E5678FC689" in text
...
def updateBoronSoftdevice():
	...
	command = 'particle flash --serial --yes ' + boronSoftDeviceFirmware
	print('attempting to flash boron soft device update')
...
def setConfigDoneBit():
	...
	subprocess.call('dfu-util -d '+dfuDeviceID+' -a 1 -s '+configDoneAddress+':leave -D ' + boronConfigDoneFirmware,
					shell=True)
	time.sleep(2)
